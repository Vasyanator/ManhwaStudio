"""
File: modules/ai_backend/runtime/test_device_service.py
...
from modules.ai_backend.runtime.device_service import _MemoryUserConfig, _OnnxDeviceSelector
...
class AiDeviceSentinelTests(unittest.TestCase):
    ...
    def test_not_selected_ignores_stale_onnx_configured_flags(self) -> None:
        ...
        with (
            ...
            patch(
                "modules.ai_backend.runtime.device_service.platform.system",
    ...
    def test_windows_gpu_name_probe_falls_back_to_wmic(self) -> None:
        ...
        with (
            patch("modules.ai_backend.runtime.device_service.shutil.which") as which,
