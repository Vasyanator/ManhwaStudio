...
from modules.ai_backend import paddle_vl_ocr_service as service_module
from modules.ai_backend.model_manager import LoadedModelManager
from modules.ai_backend.paddle_vl_ocr_service import (
    PaddleVlOcrService,
...
class _FakeModel:
    ...
    def to(self, *_args: Any, **_kwargs: Any) -> "_FakeModel":
        raise AssertionError(
            ...
            "host->device move must go through rocm_mmap_transfer.move_module_to, "
            "not Module.to"
        )
