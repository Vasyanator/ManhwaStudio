"""
File: modules/ai_backend/test_surya_checkpoints.py

Purpose:
Unit tests for the shared Surya checkpoint presence/download helpers used by
`surya_ocr_service` and `surya_text_detector_service`.
...
from modules.ai_backend import surya_checkpoints as ckpt
