...
`crate::tabs::typing::segmentation::ru`; здесь — только выбор позиции разрыва с
...
use crate::tabs::typing::segmentation::base::SOFT_HYPHEN;
use crate::tabs::typing::segmentation::count_layout_units;
use crate::tabs::typing::segmentation::ru::{
